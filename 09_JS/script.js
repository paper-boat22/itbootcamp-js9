...
let x = 3; // Deklarisali smo promenljivu x i dodelili jo vrednost 3
console.log(x);
x = "Pera";
console.log(x);

y = -10; // Dodeljuje se po;etna vrednost promenljive y
console.log(y);
x = 8;
console.log(x - y); // 18
let z = true;
...
x = 6;
console.log(x++); // 6, prvo se iskoristi stara vrednost x pa se uveca
console.log(x); // 7
console.log(++x); // 8, prvo se uveca vrednost x, pa se onda koristi

x = 6;
console.log(x--); // 6
console.log(--x); // 4

console.log(7 / 3); // (7) = 2 * (3) + 1 -> kolicnik je 2, ostatak 1
console.log( 7 % 3); 
